module "mongodb" {
    ...
    source = "git::https://github.com/RajeshMukkudipalli/terraform-aws-securitygroup.git?ref=main"
    project = var.project
...
module "bastion" {
    #source = "../../terraform-aws-securitygroup"
    source = "git::https://github.com/RajeshMukkudi[alli/terraform-aws-securitygroup.git?ref=main"
    project = var.project
    environment = var.environment
